...
class ProfileScreen extends StatelessWidget {
  ...
  List<Widget> _profileMenus(BuildContext context) {
    final menus = [
      _ProfileMenuData('My Account', "assets/icons/home.svg", () {}),
      _ProfileMenuData('Notifications', "assets/icons/bell.svg", () {}),
      _ProfileMenuData('Settings', "assets/icons/settings.svg", () {}),
      _ProfileMenuData('Help Center', "assets/icons/Questionmark.svg", () {}),
      _ProfileMenuData('Log Out', "assets/icons/logout.svg", () {}),
    ];
...
class _ProfileMenuData {
  ...
  const _ProfileMenuData(this.text, this.icon, this.press);
}
